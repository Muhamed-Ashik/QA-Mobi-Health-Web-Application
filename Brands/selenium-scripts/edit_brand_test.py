...
driver.find_element(By.XPATH, '//a[contains(@href, "/admin/brands/edit")]').click()
time.sleep(2)

brand_input = driver.find_element(By.Name, "brand")
brand_status = driver.find_element(By.Name, "status")

brand_input.clear()
brand_input.send_keys("Samsung")

brand_status.send_keys(0)
